...
def get_gennerator(latent_size,device):
...
def train_discriminator(real_images, opt_d,discriminator,generator,device,latent_size=100):
...
def train_generator(opt_g,discriminator,generator,device):
...
if __name__ == "__main__":
    ...
    lr = 2e-4
    epochs = 100
    generator = get_gennerator(latent_size,device)
    ...
    with open('generator_cat1','wb') as generator_file:
        pickle.dump(generator,generator_file)

    with open('discriminator_cat1','wb') as discriminator_file:
